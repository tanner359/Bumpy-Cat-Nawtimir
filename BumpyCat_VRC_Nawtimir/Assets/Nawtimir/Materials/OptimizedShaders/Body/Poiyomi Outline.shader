Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Toon Outline/5980623b8a6917d4b81a751cfcf4a4e1"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			)
			{
				...
				if((1.0 /*_UVTileDissolveEnabled*/) && (1.0 /*_UVTileDissolveDiscardAtMax*/))
				{
					...
					dissolveUdim += (v.uv0.xy * ((1.0 /*_UVTileDissolveUV*/) == 0));
					dissolveUdim += (v.uv1.xy * ((1.0 /*_UVTileDissolveUV*/) == 1));
					dissolveUdim += (v.uv2.xy * ((1.0 /*_UVTileDissolveUV*/) == 2));
					dissolveUdim += (v.uv3.xy * ((1.0 /*_UVTileDissolveUV*/) == 3));
					...
					isDiscardedFromDissolve += (dissolveUdim.y >= 1 && dissolveUdim.y < 2) * dot(float4((0.0 /*_UVTileDissolveAlpha_Row1_0*/), (0.0 /*_UVTileDissolveAlpha_Row1_1*/), _UVTileDissolveAlpha_Row1_2, _UVTileDissolveAlpha_Row1_3), xMaskDissolve);
					...
					isDiscardedFromDissolve += (dissolveUdim.y >= 3 && dissolveUdim.y < 4) * dot(float4((0.0 /*_UVTileDissolveAlpha_Row3_0*/), _UVTileDissolveAlpha_Row3_1, _UVTileDissolveAlpha_Row3_2, _UVTileDissolveAlpha_Row3_3), xMaskDissolve);
			...
			void applyDecals(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, inout PoiMods poiMods, in PoiLight poiLight)
			{
				...
				Decal0.m_DecalBlendAlpha = (0.019 /*_DecalBlendAlpha*/);
				...
				Decal2.m_DecalMaskChannel = (1.0 /*_Decal2MaskChannel*/);
			...
			void applyDissolve(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods, in PoiCam poiCam, in PoiLight poiLight)
			{
				...
				{
					float2 udim = floor(poiMesh.uv[(int)(1.0 /*_UVTileDissolveUV*/)]);
					...
					da += (udim.y >= 1 && udim.y < 2) * dot(float4((0.0 /*_UVTileDissolveAlpha_Row1_0*/), (0.0 /*_UVTileDissolveAlpha_Row1_1*/), _UVTileDissolveAlpha_Row1_2, _UVTileDissolveAlpha_Row1_3), xMask);
					...
					da += (udim.y >= 3 && udim.y < 4) * dot(float4((0.0 /*_UVTileDissolveAlpha_Row3_0*/), _UVTileDissolveAlpha_Row3_1, _UVTileDissolveAlpha_Row3_2, _UVTileDissolveAlpha_Row3_3), xMask);
				}
				#ifdef POI_AUDIOLINK
				...
				switch((1.0 /*_DissolveType*/))
				{
					...
					{
						da = remap(da, 0, 1, -(0.027 /*_DissolveEdgeWidth*/), 1);
						dissolveAlpha = da;
						...
						edgeAlpha = remapClamped(da + (0.027 /*_DissolveEdgeWidth*/), da, noise) * (1 - dissolveAlpha);
						break;
					}
					...
					case 3: // Spherical
					{
						...
						{
							da = remap(da, 1, 0, -(0.027 /*_DissolveEdgeWidth*/), 1);
						} else {
							da = remap(da, 0, 1, -(0.027 /*_DissolveEdgeWidth*/), 1);
						}
						dissolveAlpha = da;
						...
						if((0.0 /*_SphericalDissolveInvert*/))
						{
							...
							edgeAlpha = smoothstep((0.027 /*_DissolveEdgeWidth*/) + .00001, 0, -normalizedDistance);
						} else {
							dissolveAlpha = (normalizedDistance < 0) ? 1 : 0;
							edgeAlpha = smoothstep((0.027 /*_DissolveEdgeWidth*/) + .00001, 0, normalizedDistance);
						}
				...
				if ((0.027 /*_DissolveEdgeWidth*/) || ((1.0 /*_DissolveType*/) == 2 && (0.1 /*_DissolveP2PEdgeLength*/) != 0))
				{
				...
				poiFragData.emission += lerp(0, dissolveToTexture * (0.0 /*_DissolveToEmissionStrength*/), dissolveAlpha) + lerp(0, edgeColor.rgb * (5.0 /*_DissolveEdgeEmission*/), smoothstep(0, 1 - (0.0 /*_DissolveEdgeHardness*/) * .99999999999, edgeAlpha));
				#endif
			}
			#endif
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				switch((1.0 /*_MatcapUVMode*/))
				{
					case 0:
					{
						...
						matcapUV = noSknewViewNormal.rg * (0.0 /*_MatcapBorder*/) + 0.5;
						break;
					}
					case 1:
					{
						...
						matcapUV = float2(dot(worldViewRight, normal0), dot(worldViewUp, normal0)) * (0.0 /*_MatcapBorder*/) + 0.5;
						break;
					}
					case 2:
					{
						...
						matcapUV = uv * (0.0 /*_MatcapBorder*/) + 0.5;
						break;
					}
				}
				...
				if ((0.0 /*_MatcapSmoothnessEnabled*/))
				{
					matcap = UNITY_SAMPLE_TEX2D_SAMPLER_LOD(_Matcap, _MainTex, TRANSFORM_TEX(matcapUV, _Matcap), matcapSmoothness) * float4(poiThemeColor(poiMods, float4(0.2140411,0.2140411,0.2140411,1).rgb, (0.0 /*_MatcapColorThemeIndex*/)), float4(0.2140411,0.2140411,0.2140411,1).a);
				}
				else
				{
					matcap = UNITY_SAMPLE_TEX2D_SAMPLER(_Matcap, _MainTex, TRANSFORM_TEX(matcapUV, _Matcap)) * float4(poiThemeColor(poiMods, float4(0.2140411,0.2140411,0.2140411,1).rgb, (0.0 /*_MatcapColorThemeIndex*/)), float4(0.2140411,0.2140411,0.2140411,1).a);
				}
				#else
				matcap = float4(poiThemeColor(poiMods, float4(0.2140411,0.2140411,0.2140411,1).rgb, (0.0 /*_MatcapColorThemeIndex*/)), float4(0.2140411,0.2140411,0.2140411,1).a);
				#endif
				matcap.rgb *= (0.5 /*_MatcapIntensity*/);
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.429 /*_MatcapAdd*/), (0.0 /*_MatcapAddToLight*/), (0.0 /*_MatcapMultiply*/), (0.0 /*_MatcapReplace*/), (0.429 /*_MatcapMixed*/), (0.0 /*_MatcapScreen*/), matcap, matcapMask, (0.0 /*_MatcapEmissionStrength*/), (0.0 /*_MatcapLightMask*/), (0.0 /*_MatcapMaskGlobalMask*/), (2.0 /*_MatcapMaskGlobalMaskBlendType*/));
				#endif
				#ifdef COLOR_GRADING_HDR_3D
				...
				if ((0.0 /*_Matcap2SmoothnessEnabled*/))
				{
					matcap2 = UNITY_SAMPLE_TEX2D_SAMPLER_LOD(_Matcap2, _MainTex, TRANSFORM_TEX(matcapUV, _Matcap2), matcap2Smoothness) * float4(poiThemeColor(poiMods, float4(0.3812781,0.3812781,0.3812781,1).rgb, (0.0 /*_Matcap2ColorThemeIndex*/)), float4(0.3812781,0.3812781,0.3812781,1).a);
				}
				else
				{
					matcap2 = UNITY_SAMPLE_TEX2D_SAMPLER(_Matcap2, _MainTex, TRANSFORM_TEX(matcapUV, _Matcap2)) * float4(poiThemeColor(poiMods, float4(0.3812781,0.3812781,0.3812781,1).rgb, (0.0 /*_Matcap2ColorThemeIndex*/)), float4(0.3812781,0.3812781,0.3812781,1).a);
				}
				#else
				matcap2 = float4(poiThemeColor(poiMods, float4(0.3812781,0.3812781,0.3812781,1).rgb, (0.0 /*_Matcap2ColorThemeIndex*/)), float4(0.3812781,0.3812781,0.3812781,1).a);
				#endif
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.0 /*_Matcap2Add*/), (0.0 /*_Matcap2AddToLight*/), _Matcap2Multiply, _Matcap2Replace, (0.0 /*_Matcap2Mixed*/), (0.0 /*_Matcap2Screen*/), matcap2, matcap2Mask, (0.0 /*_Matcap2EmissionStrength*/), (0.0 /*_Matcap2LightMask*/), (0.0 /*_Matcap2MaskGlobalMask*/), (2.0 /*_Matcap2MaskGlobalMaskBlendType*/));
				#endif
				#ifdef POI_MATCAP2
				...
				#endif
				matcap3.rgb *= (1.8 /*_Matcap3Intensity*/);
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.0 /*_Matcap3Add*/), (0.0 /*_Matcap3AddToLight*/), _Matcap3Multiply, _Matcap3Replace, (0.0 /*_Matcap3Mixed*/), (0.0 /*_Matcap3Screen*/), matcap3, matcap3Mask, (0.0 /*_Matcap3EmissionStrength*/), (0.0 /*_Matcap3LightMask*/), (0.0 /*_Matcap3MaskGlobalMask*/), (2.0 /*_Matcap3MaskGlobalMaskBlendType*/));
				#endif
				#ifdef POI_MATCAP3
				float3 normal3 = poiMesh.normals[(1.0 /*_Matcap4Normal*/)];
				matcapUV = 0;
				switch((1.0 /*_Matcap4UVMode*/))
				{
					case 0:
					{
						...
						float3 NormalBlend_MatCapUV_Base = (mul(UNITY_MATRIX_V, float4(poiCam.viewDir, 0)).rgb * float3(-1, -1, 1)) + float3(0, 0, 1);
						float3 noSknewViewNormal = NormalBlend_MatCapUV_Base * dot(NormalBlend_MatCapUV_Base, NormalBlend_MatCapUV_Detail) / NormalBlend_MatCapUV_Base.b - NormalBlend_MatCapUV_Detail;
						matcapUV = noSknewViewNormal.rg * (0.43 /*_Matcap4Border*/) + 0.5;
						break;
					}
					case 1:
					{
						float3 worldViewUp = normalize(float3(0, 1, 0) - poiCam.viewDir * dot(poiCam.viewDir, float3(0, 1, 0)));
						float3 worldViewRight = normalize(cross(poiCam.viewDir, worldViewUp));
						matcapUV = float2(dot(worldViewRight, normal3), dot(worldViewUp, normal3)) * (0.43 /*_Matcap4Border*/) + 0.5;
						break;
					}
					case 2:
					{
						...
						float2 uv = float2(dot(reflection, float3(1, 0, 0)), dot(reflection, float3(0, 1, 0)));
						matcapUV = uv * (0.43 /*_Matcap4Border*/) + 0.5;
						break;
					}
				}
				matcapUV = lerp(matcapUV, poiMesh.uv[(1.0 /*_Matcap4UVToBlend*/)], float4(0,0,0,0).xy);
				matcapUV = RotateUV(matcapUV, (0.0 /*_Matcap4Rotation*/) * PI, float2(.5, .5), 1.0f);
				if (IsInMirror())
				{
					matcapUV.x = 1 - matcapUV.x;
				}
				...
				{
					if (float4(0.00390625,0.00390625,256,256).z == 8192) mipCount4 = 13;
					if (float4(0.00390625,0.00390625,256,256).z == 4096) mipCount4 = 12;
					if (float4(0.00390625,0.00390625,256,256).z == 2048) mipCount4 = 11;
					if (float4(0.00390625,0.00390625,256,256).z == 1024) mipCount4 = 10;
					if (float4(0.00390625,0.00390625,256,256).z == 512) mipCount4 = 9;
					if (float4(0.00390625,0.00390625,256,256).z == 256) mipCount4 = 8;
					if (float4(0.00390625,0.00390625,256,256).z == 128) mipCount4 = 7;
					if (float4(0.00390625,0.00390625,256,256).z == 64) mipCount4 = 6;
					if (float4(0.00390625,0.00390625,256,256).z == 32) mipCount4 = 5;
					matcap4Smoothness = (1.0 /*_Matcap4Smoothness*/);
					if ((0.0 /*_Matcap4MaskSmoothnessApply*/))
					{
						#if defined(PROP_MATCAP4MASK) || !defined(OPTIMIZER_ENABLED)
						matcap4Smoothness *= POI2D_SAMPLER_PAN(_Matcap4Mask, _MainTex, poiUV(poiMesh.uv[(0.0 /*_Matcap4MaskUV*/)], _Matcap4Mask_ST), float4(0,0,0,0))[(3.0 /*_Matcap4MaskSmoothnessChannel*/)];
						#endif
					}
				...
				if ((0.0 /*_Matcap4SmoothnessEnabled*/))
				{
					matcap4 = UNITY_SAMPLE_TEX2D_SAMPLER_LOD(_Matcap4, _MainTex, TRANSFORM_TEX(matcapUV, _Matcap4), matcap4Smoothness) * float4(poiThemeColor(poiMods, float4(1,1,1,1).rgb, (0.0 /*_Matcap4ColorThemeIndex*/)), float4(1,1,1,1).a);
				}
				else
				{
				...
				#endif
				matcap4.rgb *= (5.0 /*_Matcap4Intensity*/);
				matcap4.rgb = lerp(matcap4.rgb, matcap4.rgb * poiFragData.baseColor.rgb, (0.0 /*_Matcap4BaseColorMix*/));
				#if defined(PROP_MATCAP4MASK) || !defined(OPTIMIZER_ENABLED)
				matcap4Mask = POI2D_SAMPLER_PAN(_Matcap4Mask, _MainTex, poiUV(poiMesh.uv[(0.0 /*_Matcap4MaskUV*/)], _Matcap4Mask_ST), float4(0,0,0,0))[(0.0 /*_Matcap4MaskChannel*/)];
				#else
				matcap4Mask = 1;
				#endif
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.0 /*_Matcap4Add*/), (0.0 /*_Matcap4AddToLight*/), (1.0 /*_Matcap4Multiply*/), (1.0 /*_Matcap4Replace*/), (0.0 /*_Matcap4Mixed*/), (0.25 /*_Matcap4Screen*/), matcap4, matcap4Mask, (0.0 /*_Matcap4EmissionStrength*/), (0.0 /*_Matcap4LightMask*/), (0.0 /*_Matcap4MaskGlobalMask*/), (2.0 /*_Matcap4MaskGlobalMaskBlendType*/));
				#endif
			}
			#endif
			...
			float3 applyEmission(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				float glowInTheDarkMultiplier0 = calculateGlowInTheDark((0.0 /*_GITDEMinLight*/), (1.0 /*_GITDEMaxLight*/), _GITDEMinEmissionMultiplier, _GITDEMaxEmissionMultiplier, (1.0 /*_EnableGITDEmission*/), (0.0 /*_GITDEWorldOrMesh*/), poiLight);
				#if defined(PROP_EMISSIONMAP) || !defined(OPTIMIZER_ENABLED)
				if (!(1.0 /*_EmissionCenterOutEnabled*/))
				{
					emissionColor0 = POI2D_SAMPLER_PAN(_EmissionMap, _MainTex, poiUV(poiMesh.uv[(0.0 /*_EmissionMapUV*/)], float4(1,1,0,0)), float4(0,0,0,0)).rgb * lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap*/)).rgb * poiThemeColor(poiMods, float4(0,0.7529412,5.992157,1).rgb, (0.0 /*_EmissionColorThemeIndex*/));
				}
				else
				{
					emissionColor0 = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionMap, _MainTex, ((.5 + poiLight.nDotV * .5) * float4(1,1,0,0).xy) + _Time.x * (1.0 /*_EmissionCenterOutSpeed*/)).rgb * lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap*/)).rgb * poiThemeColor(poiMods, float4(0,0.7529412,5.992157,1).rgb, (0.0 /*_EmissionColorThemeIndex*/));
				}
				#else
				emissionColor0 = lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap*/)).rgb * poiThemeColor(poiMods, float4(0,0.7529412,5.992157,1).rgb, (0.0 /*_EmissionColorThemeIndex*/));
				#endif
				...
				#if defined(PROP_EMISSIONMASK) || !defined(OPTIMIZER_ENABLED)
				float emissionMask0 = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionMask, _MainTex, poiUV(poiMesh.uv[(0.0 /*_EmissionMaskUV*/)], _EmissionMask_ST) + _Time.x * float4(0,0,0,0))[(0.0 /*_EmissionMaskChannel*/)];
				#else
				...
				applyALEmmissionStrength(poiMods, emissionStrength0, float4(0,0.5,0,0), (2.0 /*_EmissionAL0StrengthBand*/), float4(0,0.5,0,0), (0.0 /*_EmissionAL0MultipliersBand*/), (1.0 /*_EmissionAL0Enabled*/));
				applyALCenterOutEmission(poiMods, poiLight.nDotV, emissionStrength0, (0.3 /*_AudioLinkEmission0CenterOutSize*/), (1.0 /*_AudioLinkEmission0CenterOutBand*/), float4(0.1,1,0,0), (1.0 /*_EmissionAL0Enabled*/), (0.1 /*_AudioLinkEmission0CenterOutDuration*/));
			...
			float3 applyEmission1(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				float glowInTheDarkMultiplier1 = calculateGlowInTheDark((0.0 /*_GITDEMinLight1*/), (1.0 /*_GITDEMaxLight1*/), _GITDEMinEmissionMultiplier1, _GITDEMaxEmissionMultiplier1, (1.0 /*_EnableGITDEmission1*/), (0.0 /*_GITDEWorldOrMesh1*/), poiLight);
				#if defined(PROP_EMISSIONMAP1) || !defined(OPTIMIZER_ENABLED)
				if (!(1.0 /*_EmissionCenterOutEnabled1*/))
				{
					emissionColor1 = POI2D_SAMPLER_PAN(_EmissionMap1, _MainTex, poiUV(poiMesh.uv[(0.0 /*_EmissionMap1UV*/)], float4(5,5,0,0)), float4(0,-5,0,0)) * lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap1*/)).rgb * poiThemeColor(poiMods, float4(1.059274,0,0.171924,1).rgb, (0.0 /*_EmissionColor1ThemeIndex*/));
				}
				else
				{
					emissionColor1 = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionMap1, _MainTex, ((.5 + poiLight.nDotV * .5) * float4(5,5,0,0).xy) + _Time.x * (5.0 /*_EmissionCenterOutSpeed1*/)).rgb * lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap1*/)).rgb * poiThemeColor(poiMods, float4(1.059274,0,0.171924,1).rgb, (0.0 /*_EmissionColor1ThemeIndex*/));
				}
				#else
				emissionColor1 = lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap1*/)).rgb * poiThemeColor(poiMods, float4(1.059274,0,0.171924,1).rgb, (0.0 /*_EmissionColor1ThemeIndex*/));
				#endif
				...
				#if defined(PROP_EMISSIONMASK1) || !defined(OPTIMIZER_ENABLED)
				float emissionMask1 = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionMask1, _MainTex, poiUV(poiMesh.uv[(0.0 /*_EmissionMask1UV*/)], _EmissionMask1_ST) + _Time.x * float4(0,0,0,0))[(0.0 /*_EmissionMask1Channel*/)];
				#else
				...
				applyALEmmissionStrength(poiMods, emissionStrength1, float4(0,0.5,0,0), (1.0 /*_EmissionAL1StrengthBand*/), float4(0,0.5,0,0), (0.0 /*_EmissionAL1MultipliersBand*/), (1.0 /*_EmissionAL1Enabled*/));
				applyALCenterOutEmission(poiMods, poiLight.nDotV, emissionStrength1, (0.3 /*_AudioLinkEmission1CenterOutSize*/), (3.0 /*_AudioLinkEmission1CenterOutBand*/), float4(0.1,1,0,0), (1.0 /*_EmissionAL1Enabled*/), (0.1 /*_AudioLinkEmission1CenterOutDuration*/));
			...
			{
				float enviroRimAlpha = saturate(1 - smoothstep(min((0.0 /*_RimEnviroSharpness*/), (0.695 /*_RimEnviroWidth*/)), (0.695 /*_RimEnviroWidth*/), poiCam.vDotN));
			...
			void applyIridescence(inout PoiFragData poiFragData, PoiMesh poiMesh, PoiCam poiCam, inout PoiMods poiMods)
			{
				...
				#ifdef POI_AUDIOLINK
				iridescencePan += AudioLinkGetChronoTime((6.0 /*_IridescenceAudioLinkChronoPanType*/), (0.0 /*_IridescenceAudioLinkChronoPanBand*/)) * _IridescenceAudioLinkChronoPanSpeed;
				#endif
				iridescenceColor = UNITY_SAMPLE_TEX2D_SAMPLER(_IridescenceRamp, _MainTex, (1 - abs(ndotv)) * float4(1,1,0,0).xy + iridescencePan);
				if ((1.0 /*_IridescenceHueShiftEnabled*/) == 1)
				{
					float hue = _IridescenceHueShift + frac(_Time.x * (0.0 /*_IridescenceHueShiftSpeed*/));
				...
				{
					emissionStrength += lerp(_IridescenceAudioLinkEmissionAdd[0], _IridescenceAudioLinkEmissionAdd[1], poiMods.audioLink[(0.0 /*_IridescenceAudioLinkEmissionAddBand*/)]);
				}
				if (any(_IridescenceAudioLinkIntensityAdd))
				{
					iridescenceIntensity += lerp(_IridescenceAudioLinkIntensityAdd[0], _IridescenceAudioLinkIntensityAdd[1], poiMods.audioLink[(2.0 /*_IridescenceAudioLinkIntensityAddBand*/)]);
				}
				#endif
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#endif
				ApplyPoiyomiRimLighting(poiFragData, poiMesh, poiCam, poiLight, poiMods, (1.0 /*_Is_NormalMapToRimLight*/), (0.0 /*_RimLightingInvert*/), (0.94 /*_RimPower*/), (0.0 /*_RimStrength*/), (0.0 /*_RimShadowWidth*/), (0.0 /*_RimShadowToggle*/), (0.688 /*_RimWidth*/), (0.478 /*_RimBlendStrength*/), rimMask, (0.0 /*_RimGlobalMask*/), (2.0 /*_RimGlobalMaskBlendType*/), rimColor, float4(0.08865559,0.006995406,0.004776951,1), (0.0 /*_RimLightColorThemeIndex*/), (0.0 /*_RimHueShiftEnabled*/), (0.0 /*_RimHueShift*/), (0.0 /*_RimHueShiftSpeed*/), (0.0 /*_RimSharpness*/), (0.0 /*_RimShadowMaskRampType*/), (0.0 /*_RimShadowMaskInvert*/), (1.0 /*_RimShadowMaskStrength*/), float4(0,0,0,1), (0.0 /*_RimApplyGlobalMaskIndex*/), (2.0 /*_RimApplyGlobalMaskBlendType*/), (0.0 /*_RimBaseColorMix*/), (10.0 /*_RimBrightness*/), (0.0 /*_RimBlendMode*/), AudioLinkRimWidthBand, AudioLinkRimWidthAdd, AudioLinkRimEmissionBand, AudioLinkRimEmissionAdd, AudioLinkRimBrightnessBand, AudioLinkRimBrightnessAdd, (0.0 /*_RimClamp*/), rimBias, (0.0 /*_RimBiasIntensity*/));
				#endif
				#endif
				#ifdef POI_IRIDESCENCE
