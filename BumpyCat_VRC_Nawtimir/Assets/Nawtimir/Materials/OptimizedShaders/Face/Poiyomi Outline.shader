Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Toon Outline/65dac4fffa31d134bb85af4de3da78d0"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyDecals(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, inout PoiMods poiMods, in PoiLight poiLight)
			{
				...
				Decal3.m_DecalMaskChannel = (1.0 /*_Decal3MaskChannel*/);
			...
			void applyDissolve(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods, in PoiCam poiCam, in PoiLight poiLight)
			{
				...
				#if defined(PROP_DISSOLVETOTEXTURE) || !defined(OPTIMIZER_ENABLED)
				dissolveToTexture = POI2D_SAMPLER_PAN(_DissolveToTexture, _MainTex, poiUV(poiMesh.uv[(0.0 /*_DissolveToTextureUV*/)], float4(1,1,0,0)), float4(0,-3,0,0)) * float4(poiThemeColor(poiMods, float4(1,1,1,1).rgb, (0.0 /*_DissolveTextureColorThemeIndex*/)), float4(1,1,1,1).a);
				#else
				...
				switch((1.0 /*_DissolveType*/))
				{
					...
					{
						da = remap(da, 0, 1, -(0.265 /*_DissolveEdgeWidth*/), 1);
						dissolveAlpha = da;
						...
						edgeAlpha = remapClamped(da + (0.265 /*_DissolveEdgeWidth*/), da, noise) * (1 - dissolveAlpha);
						break;
					}
					...
					case 3: // Spherical
					{
						...
						{
							da = remap(da, 1, 0, -(0.265 /*_DissolveEdgeWidth*/), 1);
						} else {
							da = remap(da, 0, 1, -(0.265 /*_DissolveEdgeWidth*/), 1);
						}
						dissolveAlpha = da;
						...
						if((0.0 /*_SphericalDissolveInvert*/))
						{
							...
							edgeAlpha = smoothstep((0.265 /*_DissolveEdgeWidth*/) + .00001, 0, -normalizedDistance);
						} else {
							dissolveAlpha = (normalizedDistance < 0) ? 1 : 0;
							edgeAlpha = smoothstep((0.265 /*_DissolveEdgeWidth*/) + .00001, 0, normalizedDistance);
						}
				...
				if ((0.265 /*_DissolveEdgeWidth*/) || ((1.0 /*_DissolveType*/) == 2 && (0.1 /*_DissolveP2PEdgeLength*/) != 0))
				{
				...
				poiFragData.emission += lerp(0, dissolveToTexture * (4.59 /*_DissolveToEmissionStrength*/), dissolveAlpha) + lerp(0, edgeColor.rgb * (0.0 /*_DissolveEdgeEmission*/), smoothstep(0, 1 - (0.0 /*_DissolveEdgeHardness*/) * .99999999999, edgeAlpha));
				#endif
			}
			#endif
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				#endif
				matcap.rgb *= (0.84 /*_MatcapIntensity*/);
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.01 /*_MatcapAdd*/), (0.0 /*_MatcapAddToLight*/), (0.0 /*_MatcapMultiply*/), (0.0 /*_MatcapReplace*/), (0.416 /*_MatcapMixed*/), (0.0 /*_MatcapScreen*/), matcap, matcapMask, (0.0 /*_MatcapEmissionStrength*/), (0.0 /*_MatcapLightMask*/), (0.0 /*_MatcapMaskGlobalMask*/), (2.0 /*_MatcapMaskGlobalMaskBlendType*/));
				#endif
				#ifdef COLOR_GRADING_HDR_3D
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.235 /*_Matcap2Add*/), (0.0 /*_Matcap2AddToLight*/), (1.0 /*_Matcap2Multiply*/), (0.0 /*_Matcap2Replace*/), (0.0 /*_Matcap2Mixed*/), (0.0 /*_Matcap2Screen*/), matcap2, matcap2Mask, (0.0 /*_Matcap2EmissionStrength*/), (0.0 /*_Matcap2LightMask*/), (0.0 /*_Matcap2MaskGlobalMask*/), (2.0 /*_Matcap2MaskGlobalMaskBlendType*/));
				#endif
			}
			#endif
			...
			float3 applyEmission(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				float glowInTheDarkMultiplier0 = calculateGlowInTheDark((0.0 /*_GITDEMinLight*/), (1.0 /*_GITDEMaxLight*/), (0.0 /*_GITDEMinEmissionMultiplier*/), _GITDEMaxEmissionMultiplier, (0.0 /*_EnableGITDEmission*/), (0.0 /*_GITDEWorldOrMesh*/), poiLight);
				#if defined(PROP_EMISSIONMAP) || !defined(OPTIMIZER_ENABLED)
				if (!(0.0 /*_EmissionCenterOutEnabled*/))
				{
					emissionColor0 = POI2D_SAMPLER_PAN(_EmissionMap, _MainTex, poiUV(poiMesh.uv[(0.0 /*_EmissionMapUV*/)], float4(1,1,0,0)), float4(0,0,0,0)).rgb * lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap*/)).rgb * poiThemeColor(poiMods, float4(0,0.09696119,2.996078,1).rgb, (0.0 /*_EmissionColorThemeIndex*/));
				}
				else
				{
					emissionColor0 = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionMap, _MainTex, ((.5 + poiLight.nDotV * .5) * float4(1,1,0,0).xy) + _Time.x * (5.0 /*_EmissionCenterOutSpeed*/)).rgb * lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap*/)).rgb * poiThemeColor(poiMods, float4(0,0.09696119,2.996078,1).rgb, (0.0 /*_EmissionColorThemeIndex*/));
				}
				#else
				emissionColor0 = lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap*/)).rgb * poiThemeColor(poiMods, float4(0,0.09696119,2.996078,1).rgb, (0.0 /*_EmissionColorThemeIndex*/));
				#endif
				...
				applyALEmmissionStrength(poiMods, emissionStrength0, float4(0,0,0,0), (0.0 /*_EmissionAL0StrengthBand*/), float4(0,0,0,0), (0.0 /*_EmissionAL0MultipliersBand*/), (0.0 /*_EmissionAL0Enabled*/));
				applyALCenterOutEmission(poiMods, poiLight.nDotV, emissionStrength0, (0.0 /*_AudioLinkEmission0CenterOutSize*/), (0.0 /*_AudioLinkEmission0CenterOutBand*/), float4(0,0,0,0), (0.0 /*_EmissionAL0Enabled*/), (0.0 /*_AudioLinkEmission0CenterOutDuration*/));
			...
			float3 applyEmission1(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				float glowInTheDarkMultiplier1 = calculateGlowInTheDark((0.0 /*_GITDEMinLight1*/), (1.0 /*_GITDEMaxLight1*/), (0.0 /*_GITDEMinEmissionMultiplier1*/), _GITDEMaxEmissionMultiplier1, (0.0 /*_EnableGITDEmission1*/), (0.0 /*_GITDEWorldOrMesh1*/), poiLight);
				#if defined(PROP_EMISSIONMAP1) || !defined(OPTIMIZER_ENABLED)
				if (!(0.0 /*_EmissionCenterOutEnabled1*/))
				{
					emissionColor1 = POI2D_SAMPLER_PAN(_EmissionMap1, _MainTex, poiUV(poiMesh.uv[(0.0 /*_EmissionMap1UV*/)], float4(1,1,0,0)), float4(0,-5,0,0)) * lerp(1, poiFragData.baseColor, (1.0 /*_EmissionBaseColorAsMap1*/)).rgb * poiThemeColor(poiMods, float4(1.648664,0,11.98431,1).rgb, (0.0 /*_EmissionColor1ThemeIndex*/));
				}
				else
				{
					emissionColor1 = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionMap1, _MainTex, ((.5 + poiLight.nDotV * .5) * float4(1,1,0,0).xy) + _Time.x * (5.0 /*_EmissionCenterOutSpeed1*/)).rgb * lerp(1, poiFragData.baseColor, (1.0 /*_EmissionBaseColorAsMap1*/)).rgb * poiThemeColor(poiMods, float4(1.648664,0,11.98431,1).rgb, (0.0 /*_EmissionColor1ThemeIndex*/));
				}
				#else
				emissionColor1 = lerp(1, poiFragData.baseColor, (1.0 /*_EmissionBaseColorAsMap1*/)).rgb * poiThemeColor(poiMods, float4(1.648664,0,11.98431,1).rgb, (0.0 /*_EmissionColor1ThemeIndex*/));
				#endif
				...
				applyALEmmissionStrength(poiMods, emissionStrength1, float4(0,0,0,0), (0.0 /*_EmissionAL1StrengthBand*/), float4(0,0,0,0), (0.0 /*_EmissionAL1MultipliersBand*/), (0.0 /*_EmissionAL1Enabled*/));
				applyALCenterOutEmission(poiMods, poiLight.nDotV, emissionStrength1, (0.0 /*_AudioLinkEmission1CenterOutSize*/), (0.0 /*_AudioLinkEmission1CenterOutBand*/), float4(0,0,0,0), (0.0 /*_EmissionAL1Enabled*/), (0.0 /*_AudioLinkEmission1CenterOutDuration*/));
			...
			float3 applyEmission2(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				float glowInTheDarkMultiplier2 = calculateGlowInTheDark((0.0 /*_GITDEMinLight2*/), (1.0 /*_GITDEMaxLight2*/), _GITDEMinEmissionMultiplier2, _GITDEMaxEmissionMultiplier2, (1.0 /*_EnableGITDEmission2*/), (0.0 /*_GITDEWorldOrMesh2*/), poiLight);
				#if defined(PROP_EMISSIONMAP2) || !defined(OPTIMIZER_ENABLED)
				if (!(1.0 /*_EmissionCenterOutEnabled2*/))
				{
					emissionColor2 = POI2D_SAMPLER_PAN(_EmissionMap2, _MainTex, poiUV(poiMesh.uv[(0.0 /*_EmissionMap2UV*/)], float4(1,1,0,0)), float4(0,0,0,0)) * lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap2*/)).rgb * poiThemeColor(poiMods, float4(0,0.7843137,5.992157,1).rgb, (0.0 /*_EmissionColor2ThemeIndex*/));
				}
				else
				{
					emissionColor2 = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionMap2, _MainTex, ((.5 + poiLight.nDotV * .5) * float4(1,1,0,0).xy) + _Time.x * (1.0 /*_EmissionCenterOutSpeed2*/)).rgb * lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap2*/)).rgb * poiThemeColor(poiMods, float4(0,0.7843137,5.992157,1).rgb, (0.0 /*_EmissionColor2ThemeIndex*/));
				}
				#else
				emissionColor2 = lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap2*/)).rgb * poiThemeColor(poiMods, float4(0,0.7843137,5.992157,1).rgb, (0.0 /*_EmissionColor2ThemeIndex*/));
				#endif
				...
				applyALEmmissionStrength(poiMods, emissionStrength2, float4(0,0.5,0,0), (2.0 /*_EmissionAL2StrengthBand*/), float4(0,0.5,0,0), (0.0 /*_EmissionAL2MultipliersBand*/), (1.0 /*_EmissionAL2Enabled*/));
				applyALCenterOutEmission(poiMods, poiLight.nDotV, emissionStrength2, (0.3 /*_AudioLinkEmission2CenterOutSize*/), (1.0 /*_AudioLinkEmission2CenterOutBand*/), float4(0.1,1,0,0), (1.0 /*_EmissionAL2Enabled*/), (0.1 /*_AudioLinkEmission2CenterOutDuration*/));
			...
			float3 applyEmission3(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				float glowInTheDarkMultiplier3 = calculateGlowInTheDark((0.0 /*_GITDEMinLight3*/), (1.0 /*_GITDEMaxLight3*/), _GITDEMinEmissionMultiplier3, _GITDEMaxEmissionMultiplier3, (1.0 /*_EnableGITDEmission3*/), (0.0 /*_GITDEWorldOrMesh3*/), poiLight);
				#if defined(PROP_EMISSIONMAP3) || !defined(OPTIMIZER_ENABLED)
				if (!(1.0 /*_EmissionCenterOutEnabled3*/))
				{
					emissionColor3 = POI2D_SAMPLER_PAN(_EmissionMap3, _MainTex, poiUV(poiMesh.uv[(0.0 /*_EmissionMap3UV*/)], float4(5,5,0,0)), float4(0,-5,0,0)) * lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap3*/)).rgb * poiThemeColor(poiMods, float4(1.059274,0,0.171924,1).rgb, (0.0 /*_EmissionColor3ThemeIndex*/));
				}
				else
				{
					emissionColor3 = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionMap3, _MainTex, ((.5 + poiLight.nDotV * .5) * float4(5,5,0,0).xy) + _Time.x * (5.0 /*_EmissionCenterOutSpeed3*/)).rgb * lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap3*/)).rgb * poiThemeColor(poiMods, float4(1.059274,0,0.171924,1).rgb, (0.0 /*_EmissionColor3ThemeIndex*/));
				}
				#else
				emissionColor3 = lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap3*/)).rgb * poiThemeColor(poiMods, float4(1.059274,0,0.171924,1).rgb, (0.0 /*_EmissionColor3ThemeIndex*/));
				#endif
				...
				emissionColor3 = hueShift(emissionColor3, frac(_EmissionHueShift3 + (0.0 /*_EmissionHueShiftSpeed3*/) * _Time.x) * (1.0 /*_EmissionHueShiftEnabled3*/));
				#if defined(PROP_EMISSIONMASK3) || !defined(OPTIMIZER_ENABLED)
				...
				applyALEmmissionStrength(poiMods, emissionStrength3, float4(0,0.5,0,0), (1.0 /*_EmissionAL3StrengthBand*/), float4(0,0.5,0,0), (0.0 /*_EmissionAL3MultipliersBand*/), (1.0 /*_EmissionAL3Enabled*/));
				applyALCenterOutEmission(poiMods, poiLight.nDotV, emissionStrength3, (0.3 /*_AudioLinkEmission3CenterOutSize*/), (3.0 /*_AudioLinkEmission3CenterOutBand*/), float4(0.1,1,0,0), (1.0 /*_EmissionAL3Enabled*/), (0.1 /*_AudioLinkEmission3CenterOutDuration*/));
