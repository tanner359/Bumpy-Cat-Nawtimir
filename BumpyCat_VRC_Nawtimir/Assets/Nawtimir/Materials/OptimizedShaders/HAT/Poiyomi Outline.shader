Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Toon Outline/7170d42570880e341b3b08e0f97fde17"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			)
			{
				...
				if((0.0 /*_UDIMDiscardMode*/) == 0) // Discard Vertices instead of just pixels
				{
					...
					(udim.x >= 2 && udim.x < 3),
					(udim.x >= 3 && udim.x < 4));
					isDiscarded += (udim.y >= 0 && udim.y < 1) * dot(float4((0.0 /*_UDIMDiscardRow0_0*/), (1.0 /*_UDIMDiscardRow0_1*/), (0.0 /*_UDIMDiscardRow0_2*/), (0.0 /*_UDIMDiscardRow0_3*/)), xMask);
			...
			{
				float smoothness = (0.515 /*_MochieRoughnessMultiplier*/);
			...
			void applyIridescence(inout PoiFragData poiFragData, PoiMesh poiMesh, PoiCam poiCam, inout PoiMods poiMods)
			{
				...
				float emissionStrength = (0.6 /*_IridescenceEmissionStrength*/);
