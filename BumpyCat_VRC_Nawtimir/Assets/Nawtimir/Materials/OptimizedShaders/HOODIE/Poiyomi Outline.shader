Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Toon Outline/5e5e94fe62e6d6f4eaf832f10c594fb6"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyIridescence(inout PoiFragData poiFragData, PoiMesh poiMesh, PoiCam poiCam, inout PoiMods poiMods)
			{
				...
				{
					float hue = (1.0 /*_IridescenceHueShift*/) + frac(_Time.x * (0.0 /*_IridescenceHueShiftSpeed*/));
				...
				float emissionStrength = (0.5 /*_IridescenceEmissionStrength*/);
				float iridescenceIntensity = (4.84 /*_IridescenceIntensity*/);
				#ifdef POI_AUDIOLINK
				...
				poiFragData.emission += saturate(iridescenceColor.rgb * (4.84 /*_IridescenceIntensity*/)) * iridescenceColor.a * iridescenceMask * emissionStrength;
			}
			#endif
