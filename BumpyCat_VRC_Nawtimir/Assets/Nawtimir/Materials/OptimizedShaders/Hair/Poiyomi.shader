Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Toon/9364fafd3b0443b4c9429d54636943ae"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			)
			{
				...
				if((1.0 /*_UVTileDissolveEnabled*/) && (1.0 /*_UVTileDissolveDiscardAtMax*/))
				{
					...
					isDiscardedFromDissolve += (dissolveUdim.y >= 1 && dissolveUdim.y < 2) * dot(float4(_UVTileDissolveAlpha_Row1_0, (0.0 /*_UVTileDissolveAlpha_Row1_1*/), _UVTileDissolveAlpha_Row1_2, (0.0 /*_UVTileDissolveAlpha_Row1_3*/)), xMaskDissolve);
					isDiscardedFromDissolve += (dissolveUdim.y >= 2 && dissolveUdim.y < 3) * dot(float4((0.0 /*_UVTileDissolveAlpha_Row2_0*/), _UVTileDissolveAlpha_Row2_1, (-0.361 /*_UVTileDissolveAlpha_Row2_2*/), _UVTileDissolveAlpha_Row2_3), xMaskDissolve);
					isDiscardedFromDissolve += (dissolveUdim.y >= 3 && dissolveUdim.y < 4) * dot(float4((0.0 /*_UVTileDissolveAlpha_Row3_0*/), (0.0 /*_UVTileDissolveAlpha_Row3_1*/), (-0.809 /*_UVTileDissolveAlpha_Row3_2*/), (0.0 /*_UVTileDissolveAlpha_Row3_3*/)), xMaskDissolve);
			...
			void applyDecals(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, inout PoiMods poiMods, in PoiLight poiLight)
			{
				...
				Decal0.m_DecalTextureUV = (1.0 /*_DecalTextureUV*/);
				...
				Decal1.m_DecalTextureUV = (1.0 /*_DecalTexture1UV*/);
			...
			void applyDissolve(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods, in PoiCam poiCam, in PoiLight poiLight)
			{
				...
				if((1.0 /*_UVTileDissolveEnabled*/))
				{
					...
					da += (udim.y >= 1 && udim.y < 2) * dot(float4(_UVTileDissolveAlpha_Row1_0, (0.0 /*_UVTileDissolveAlpha_Row1_1*/), _UVTileDissolveAlpha_Row1_2, (0.0 /*_UVTileDissolveAlpha_Row1_3*/)), xMask);
					da += (udim.y >= 2 && udim.y < 3) * dot(float4((0.0 /*_UVTileDissolveAlpha_Row2_0*/), _UVTileDissolveAlpha_Row2_1, (-0.361 /*_UVTileDissolveAlpha_Row2_2*/), _UVTileDissolveAlpha_Row2_3), xMask);
					da += (udim.y >= 3 && udim.y < 4) * dot(float4((0.0 /*_UVTileDissolveAlpha_Row3_0*/), (0.0 /*_UVTileDissolveAlpha_Row3_1*/), (-0.809 /*_UVTileDissolveAlpha_Row3_2*/), (0.0 /*_UVTileDissolveAlpha_Row3_3*/)), xMask);
				}
				#ifdef POI_AUDIOLINK
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				blendMatcap(poiLight, poiFragData, poiMods, _MatcapAdd, (0.0 /*_MatcapAddToLight*/), _MatcapMultiply, (0.0 /*_MatcapReplace*/), _MatcapMixed, (0.0 /*_MatcapScreen*/), matcap, matcapMask, (0.0 /*_MatcapEmissionStrength*/), (0.0 /*_MatcapLightMask*/), (0.0 /*_MatcapMaskGlobalMask*/), (2.0 /*_MatcapMaskGlobalMaskBlendType*/));
				#endif
			}
			#endif
			#ifdef _CUBEMAP
			...
			float3 applyEmission2(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				emissionStrength2 = (0.035 /*_EmissionStrength2*/);
				...
				{
					emissionColor2 = POI2D_SAMPLER_PAN(_EmissionMap2, _MainTex, poiUV(poiMesh.uv[(0.0 /*_EmissionMap2UV*/)], float4(1,1,0,0)), float4(0,0,0,0)) * lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap2*/)).rgb * poiThemeColor(poiMods, float4(4,4,4,1).rgb, (0.0 /*_EmissionColor2ThemeIndex*/));
				}
				else
				{
					emissionColor2 = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionMap2, _MainTex, ((.5 + poiLight.nDotV * .5) * float4(1,1,0,0).xy) + _Time.x * (0.0 /*_EmissionCenterOutSpeed2*/)).rgb * lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap2*/)).rgb * poiThemeColor(poiMods, float4(4,4,4,1).rgb, (0.0 /*_EmissionColor2ThemeIndex*/));
				}
				#else
				emissionColor2 = lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap2*/)).rgb * poiThemeColor(poiMods, float4(4,4,4,1).rgb, (0.0 /*_EmissionColor2ThemeIndex*/));
				#endif
			...
			float3 applyEmission3(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				{
					emissionColor3 = POI2D_SAMPLER_PAN(_EmissionMap3, _MainTex, poiUV(poiMesh.uv[(0.0 /*_EmissionMap3UV*/)], float4(1,1,0,0)), float4(0,0,0,0)) * lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap3*/)).rgb * poiThemeColor(poiMods, float4(0.8604369,1.945335,3.572684,1).rgb, (0.0 /*_EmissionColor3ThemeIndex*/));
				}
				else
				{
					emissionColor3 = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionMap3, _MainTex, ((.5 + poiLight.nDotV * .5) * float4(1,1,0,0).xy) + _Time.x * (0.0 /*_EmissionCenterOutSpeed3*/)).rgb * lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap3*/)).rgb * poiThemeColor(poiMods, float4(0.8604369,1.945335,3.572684,1).rgb, (0.0 /*_EmissionColor3ThemeIndex*/));
				}
				#else
				emissionColor3 = lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap3*/)).rgb * poiThemeColor(poiMods, float4(0.8604369,1.945335,3.572684,1).rgb, (0.0 /*_EmissionColor3ThemeIndex*/));
				#endif
				...
				applyALEmmissionStrength(poiMods, emissionStrength3, float4(0,0.5,0,0), (2.0 /*_EmissionAL3StrengthBand*/), float4(0,0.5,0,0), (0.0 /*_EmissionAL3MultipliersBand*/), (1.0 /*_EmissionAL3Enabled*/));
				applyALCenterOutEmission(poiMods, poiLight.nDotV, emissionStrength3, (0.3 /*_AudioLinkEmission3CenterOutSize*/), (1.0 /*_AudioLinkEmission3CenterOutBand*/), float4(0.1,1,0,0), (1.0 /*_EmissionAL3Enabled*/), (0.1 /*_AudioLinkEmission3CenterOutDuration*/));
			...
			{
				float enviroRimAlpha = saturate(1 - smoothstep(min((0.0 /*_RimEnviroSharpness*/), (1.0 /*_RimEnviroWidth*/)), (1.0 /*_RimEnviroWidth*/), poiCam.vDotN));
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#endif
				ApplyPoiyomiRimLighting(poiFragData, poiMesh, poiCam, poiLight, poiMods, (1.0 /*_Is_NormalMapToRimLight*/), (0.0 /*_RimLightingInvert*/), (0.23 /*_RimPower*/), (0.0 /*_RimStrength*/), (0.0 /*_RimShadowWidth*/), (0.0 /*_RimShadowToggle*/), (0.8 /*_RimWidth*/), (0.325 /*_RimBlendStrength*/), rimMask, (0.0 /*_RimGlobalMask*/), (2.0 /*_RimGlobalMaskBlendType*/), rimColor, float4(1,1,1,1), (0.0 /*_RimLightColorThemeIndex*/), (0.0 /*_RimHueShiftEnabled*/), (0.0 /*_RimHueShift*/), (0.0 /*_RimHueShiftSpeed*/), (0.0 /*_RimSharpness*/), (0.0 /*_RimShadowMaskRampType*/), (0.0 /*_RimShadowMaskInvert*/), (1.0 /*_RimShadowMaskStrength*/), float4(0,0,0,1), (0.0 /*_RimApplyGlobalMaskIndex*/), (2.0 /*_RimApplyGlobalMaskBlendType*/), (0.0 /*_RimBaseColorMix*/), (1.0 /*_RimBrightness*/), (0.0 /*_RimBlendMode*/), AudioLinkRimWidthBand, AudioLinkRimWidthAdd, AudioLinkRimEmissionBand, AudioLinkRimEmissionAdd, AudioLinkRimBrightnessBand, AudioLinkRimBrightnessAdd, (0.0 /*_RimClamp*/), rimBias, (0.0 /*_RimBiasIntensity*/));
				#endif
				#endif
				#ifdef POI_IRIDESCENCE
