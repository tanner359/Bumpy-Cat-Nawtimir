Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Toon Outline/57e26040ee5e34d4f96bcfa56b5e8821"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			)
			{
				...
				if((1.0 /*_UVTileDissolveEnabled*/) && (1.0 /*_UVTileDissolveDiscardAtMax*/))
				{
					...
					isDiscardedFromDissolve += (dissolveUdim.y >= 0 && dissolveUdim.y < 1) * dot(float4(_UVTileDissolveAlpha_Row0_0, _UVTileDissolveAlpha_Row0_1, _UVTileDissolveAlpha_Row0_2, (0.0 /*_UVTileDissolveAlpha_Row0_3*/)), xMaskDissolve);
			...
			{
				poiFragData.alpha = saturate(poiFragData.alpha + (0.137 /*_AlphaMod*/));
			...
			void applyDissolve(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods, in PoiCam poiCam, in PoiLight poiLight)
			{
				...
				if((1.0 /*_UVTileDissolveEnabled*/))
				{
					...
					(udim.x >= 2 && udim.x < 3),
					(udim.x >= 3 && udim.x < 4));
					da += (udim.y >= 0 && udim.y < 1) * dot(float4(_UVTileDissolveAlpha_Row0_0, _UVTileDissolveAlpha_Row0_1, _UVTileDissolveAlpha_Row0_2, (0.0 /*_UVTileDissolveAlpha_Row0_3*/)), xMask);
				...
				poiFragData.emission += lerp(0, dissolveToTexture * (0.0 /*_DissolveToEmissionStrength*/), dissolveAlpha) + lerp(0, edgeColor.rgb * _DissolveEdgeEmission, smoothstep(0, 1 - (1.0 /*_DissolveEdgeHardness*/) * .99999999999, edgeAlpha));
				#endif
			}
			#endif
			...
			float3 applyEmission(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				applyALEmmissionStrength(poiMods, emissionStrength0, float4(0,0.5,0,0), (2.0 /*_EmissionAL0StrengthBand*/), float4(0,0.5,0,0), (0.0 /*_EmissionAL0MultipliersBand*/), _EmissionAL0Enabled);
				applyALCenterOutEmission(poiMods, poiLight.nDotV, emissionStrength0, (0.3 /*_AudioLinkEmission0CenterOutSize*/), (1.0 /*_AudioLinkEmission0CenterOutBand*/), float4(0.1,1,0,0), _EmissionAL0Enabled, (0.1 /*_AudioLinkEmission0CenterOutDuration*/));
			...
			float3 applyEmission1(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				applyALEmmissionStrength(poiMods, emissionStrength1, float4(0,0.5,0,0), (1.0 /*_EmissionAL1StrengthBand*/), float4(0,0.5,0,0), (0.0 /*_EmissionAL1MultipliersBand*/), _EmissionAL1Enabled);
				applyALCenterOutEmission(poiMods, poiLight.nDotV, emissionStrength1, (0.3 /*_AudioLinkEmission1CenterOutSize*/), (3.0 /*_AudioLinkEmission1CenterOutBand*/), float4(0.1,1,0,0), _EmissionAL1Enabled, (0.1 /*_AudioLinkEmission1CenterOutDuration*/));
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				clip(poiFragData.alpha - (0.165 /*_Cutoff*/));
