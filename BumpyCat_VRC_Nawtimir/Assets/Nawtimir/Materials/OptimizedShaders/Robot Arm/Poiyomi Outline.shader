Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Toon Outline/c33a1839314a8cd4db637075b47dc61a"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			)
			{
				...
				if((0.0 /*_UDIMDiscardMode*/) == 0) // Discard Vertices instead of just pixels
				{
					...
					(udim.x >= 2 && udim.x < 3),
					(udim.x >= 3 && udim.x < 4));
					isDiscarded += (udim.y >= 0 && udim.y < 1) * dot(float4((0.0 /*_UDIMDiscardRow0_0*/), (0.0 /*_UDIMDiscardRow0_1*/), (1.0 /*_UDIMDiscardRow0_2*/), (0.0 /*_UDIMDiscardRow0_3*/)), xMask);
				...
				if((1.0 /*_UVTileDissolveEnabled*/) && (1.0 /*_UVTileDissolveDiscardAtMax*/))
				{
					...
					isDiscardedFromDissolve += (dissolveUdim.y >= 1 && dissolveUdim.y < 2) * dot(float4((0.0 /*_UVTileDissolveAlpha_Row1_0*/), (0.0 /*_UVTileDissolveAlpha_Row1_1*/), _UVTileDissolveAlpha_Row1_2, (0.0 /*_UVTileDissolveAlpha_Row1_3*/)), xMaskDissolve);
					...
					isDiscardedFromDissolve += (dissolveUdim.y >= 3 && dissolveUdim.y < 4) * dot(float4(_UVTileDissolveAlpha_Row3_0, (0.0 /*_UVTileDissolveAlpha_Row3_1*/), (0.0 /*_UVTileDissolveAlpha_Row3_2*/), (0.0 /*_UVTileDissolveAlpha_Row3_3*/)), xMaskDissolve);
			...
			void applyDissolve(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods, in PoiCam poiCam, in PoiLight poiLight)
			{
				...
				if((1.0 /*_UVTileDissolveEnabled*/))
				{
					...
					da += (udim.y >= 1 && udim.y < 2) * dot(float4((0.0 /*_UVTileDissolveAlpha_Row1_0*/), (0.0 /*_UVTileDissolveAlpha_Row1_1*/), _UVTileDissolveAlpha_Row1_2, (0.0 /*_UVTileDissolveAlpha_Row1_3*/)), xMask);
					...
					da += (udim.y >= 3 && udim.y < 4) * dot(float4(_UVTileDissolveAlpha_Row3_0, (0.0 /*_UVTileDissolveAlpha_Row3_1*/), (0.0 /*_UVTileDissolveAlpha_Row3_2*/), (0.0 /*_UVTileDissolveAlpha_Row3_3*/)), xMask);
				}
				#ifdef POI_AUDIOLINK
				...
				switch((4.0 /*_DissolveType*/))
				{
					...
					{
						da = remap(da, 0, 1, -(0.026 /*_DissolveEdgeWidth*/), 1);
						dissolveAlpha = da;
						...
						edgeAlpha = remapClamped(da + (0.026 /*_DissolveEdgeWidth*/), da, noise) * (1 - dissolveAlpha);
						break;
					}
					...
					case 3: // Spherical
					{
						...
						{
							da = remap(da, 1, 0, -(0.026 /*_DissolveEdgeWidth*/), 1);
						} else {
							da = remap(da, 0, 1, -(0.026 /*_DissolveEdgeWidth*/), 1);
						}
						dissolveAlpha = da;
						...
						if((0.0 /*_SphericalDissolveInvert*/))
						{
							...
							edgeAlpha = smoothstep((0.026 /*_DissolveEdgeWidth*/) + .00001, 0, -normalizedDistance);
						} else {
							dissolveAlpha = (normalizedDistance < 0) ? 1 : 0;
							edgeAlpha = smoothstep((0.026 /*_DissolveEdgeWidth*/) + .00001, 0, normalizedDistance);
						}
				...
				if ((0.026 /*_DissolveEdgeWidth*/) || ((4.0 /*_DissolveType*/) == 2 && (0.1 /*_DissolveP2PEdgeLength*/) != 0))
				{
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				#endif
				matcap.rgb *= (2.5 /*_MatcapIntensity*/);
			...
			void applyCubemap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, in PoiLight poiLight, in PoiMods poiMods)
			{
				...
				poiFragData.baseColor.rgb += cubeMap.rgb * (0.502 /*_CubeMapAdd*/) * CubeMapMask * cubeMap.a;
