Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Toon Outline/5e1a6953d166ab04480572eed9232179"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			)
			{
				...
				if((1.0 /*_UVTileDissolveEnabled*/) && (1.0 /*_UVTileDissolveDiscardAtMax*/))
				{
					...
					isDiscardedFromDissolve += (dissolveUdim.y >= 0 && dissolveUdim.y < 1) * dot(float4((0.0 /*_UVTileDissolveAlpha_Row0_0*/), (1.0 /*_UVTileDissolveAlpha_Row0_1*/), (0.0 /*_UVTileDissolveAlpha_Row0_2*/), (0.0 /*_UVTileDissolveAlpha_Row0_3*/)), xMaskDissolve);
					...
					isDiscardedFromDissolve += (dissolveUdim.y >= 2 && dissolveUdim.y < 3) * dot(float4((0.0 /*_UVTileDissolveAlpha_Row2_0*/), (0.0 /*_UVTileDissolveAlpha_Row2_1*/), (0.0 /*_UVTileDissolveAlpha_Row2_2*/), (1.0 /*_UVTileDissolveAlpha_Row2_3*/)), xMaskDissolve);
			...
			void applyDecals(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, inout PoiMods poiMods, in PoiLight poiLight)
			{
				...
				Decal0.m_DecalBlendAlpha = (0.7 /*_DecalBlendAlpha*/);
			...
			void applyDissolve(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods, in PoiCam poiCam, in PoiLight poiLight)
			{
				...
				if((1.0 /*_UVTileDissolveEnabled*/))
				{
					...
					(udim.x >= 2 && udim.x < 3),
					(udim.x >= 3 && udim.x < 4));
					da += (udim.y >= 0 && udim.y < 1) * dot(float4((0.0 /*_UVTileDissolveAlpha_Row0_0*/), (1.0 /*_UVTileDissolveAlpha_Row0_1*/), (0.0 /*_UVTileDissolveAlpha_Row0_2*/), (0.0 /*_UVTileDissolveAlpha_Row0_3*/)), xMask);
					...
					da += (udim.y >= 2 && udim.y < 3) * dot(float4((0.0 /*_UVTileDissolveAlpha_Row2_0*/), (0.0 /*_UVTileDissolveAlpha_Row2_1*/), (0.0 /*_UVTileDissolveAlpha_Row2_2*/), (1.0 /*_UVTileDissolveAlpha_Row2_3*/)), xMask);
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				#endif
				matcap.rgb *= (5.0 /*_MatcapIntensity*/);
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.0 /*_MatcapAdd*/), (0.0 /*_MatcapAddToLight*/), (1.0 /*_MatcapMultiply*/), (0.059 /*_MatcapReplace*/), (0.0 /*_MatcapMixed*/), (0.0 /*_MatcapScreen*/), matcap, matcapMask, (0.0 /*_MatcapEmissionStrength*/), (0.0 /*_MatcapLightMask*/), (0.0 /*_MatcapMaskGlobalMask*/), (2.0 /*_MatcapMaskGlobalMaskBlendType*/));
				#endif
				#ifdef COLOR_GRADING_HDR_3D
				...
				#endif
				matcap2.rgb *= (2.5 /*_Matcap2Intensity*/);
			...
			void applyCubemap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, in PoiLight poiLight, in PoiMods poiMods)
			{
				...
				cubeMap.rgb *= poiThemeColor(poiMods, float4(0.2054128,0.2054128,0.2054128,1), (0.0 /*_CubeMapColorThemeIndex*/));
				#else
				float4 cubeMap = float4(0.21763764082, 0.21763764082, 0.21763764082, .5) * float4(poiThemeColor(poiMods, float4(0.2054128,0.2054128,0.2054128,1), (0.0 /*_CubeMapColorThemeIndex*/)), 1);
				#endif
				cubeMap.rgb *= (5.0 /*_CubeMapIntensity*/);
				#if defined(PROP_CUBEMAPMASK) || !defined(OPTIMIZER_ENABLED)
				...
				{
					cubeMap.rgb = hueShift(cubeMap.rgb, _CubeMapHueShift + _Time.x * (0.0 /*_CubeMapHueShiftSpeed*/));
				}
				CubeMapMask = min(CubeMapMask, lerp(1, poiLight.rampedLightMap, (0.0 /*_CubeMapLightMask*/)));
				poiFragData.baseColor.rgb = lerp(poiFragData.baseColor.rgb, cubeMap.rgb, (0.0 /*_CubeMapReplace*/) * CubeMapMask * cubeMap.a);
				poiFragData.baseColor.rgb *= lerp(1, cubeMap.rgb, (1.0 /*_CubeMapMultiply*/) * CubeMapMask * cubeMap.a);
			...
			void MochieBRDF(inout PoiFragData poiFragData, in PoiCam poiCam, inout PoiLight poiLight, in PoiMesh poiMesh, inout PoiMods poiMods)
			{
				...
				#endif
				reflectionMask *= (0.499 /*_MochieReflectionStrength*/);
			...
			void applyIridescence(inout PoiFragData poiFragData, PoiMesh poiMesh, PoiCam poiCam, inout PoiMods poiMods)
			{
				...
				#ifdef POI_AUDIOLINK
				iridescencePan += AudioLinkGetChronoTime((6.0 /*_IridescenceAudioLinkChronoPanType*/), (0.0 /*_IridescenceAudioLinkChronoPanBand*/)) * (0.0 /*_IridescenceAudioLinkChronoPanSpeed*/);
				#endif
				...
				#ifdef POI_AUDIOLINK
				if (any(float4(0,0.5,0,0)))
				{
					emissionStrength += lerp(float4(0,0.5,0,0)[0], float4(0,0.5,0,0)[1], poiMods.audioLink[(0.0 /*_IridescenceAudioLinkEmissionAddBand*/)]);
				}
				if (any(float4(0,0.5,0,0)))
				{
					iridescenceIntensity += lerp(float4(0,0.5,0,0)[0], float4(0,0.5,0,0)[1], poiMods.audioLink[(2.0 /*_IridescenceAudioLinkIntensityAddBand*/)]);
				}
				#endif
