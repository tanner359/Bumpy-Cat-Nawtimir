Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Toon/024b50f91faf1f045a7fd1bbf51c0618"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			{
				float2 st = frac(poiMesh.uv[(0.0 /*_GlitterUV*/)] + float4(0,-5,0,0).xy * _Time.x) * (10.0 /*_GlitterFrequency*/);
				...
				half3 glitterColor = poiThemeColor(poiMods, float4(1,0,0,1), (0.0 /*_GlitterColorThemeIndex*/));
				...
				switch((0.0 /*_GlitterMode*/))
				{
					...
					finalGlitter = lerp(0, (0.0 /*_GlitterMinBrightness*/) * glitterAlpha, glitterAlpha) + max(pow(saturate(dot(lerp(glitterReflectionDirection, poiCam.viewDir, (0.772 /*_GlitterBias*/)), poiCam.viewDir)), (178.0 /*_GlitterContrast*/)), 0);
					...
					finalGlitter = lerp(0, (0.0 /*_GlitterMinBrightness*/) * glitterAlpha, glitterAlpha) + max(pow(specAngle, (178.0 /*_GlitterContrast*/)), 0);
					glitterColor *= poiLight.directColor;
					finalGlitter *= glitterAlpha;
					break;
				}
				glitterColor *= lerp(1, poiFragData.baseColor, (0.996 /*_GlitterUseSurfaceColor*/));
				#if defined(PROP_GLITTERCOLORMAP) || !defined(OPTIMIZER_ENABLED)
