Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Toon/b9be8ca5df024fcaad3639d87644936a"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			{
				poiFragData.alpha = saturate(poiFragData.alpha + (-0.417 /*_AlphaMod*/));
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				clip(poiFragData.alpha - (0.234 /*_Cutoff*/));
